...
public class class4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        class1_list.add(new ReportCard("Ammy"));
        class1_list.add(new ReportCard("Bert"));
        class1_list.add(new ReportCard("Darvin"));
        class1_list.add(new ReportCard("Danny"));
        class1_list.add(new ReportCard("George"));
        // set English marks
