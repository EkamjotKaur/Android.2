...
public class class3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        class1_list.add(new ReportCard("Amal"));
        class1_list.add(new ReportCard("Bertie"));
        class1_list.add(new ReportCard("Boyd"));
        class1_list.add(new ReportCard("Chamlee"));
        class1_list.add(new ReportCard("Eliza"));
        // set English marks
