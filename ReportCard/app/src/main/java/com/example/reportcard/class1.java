...
public class class1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        class1_list.add(new ReportCard("Angila"));
        class1_list.add(new ReportCard("Berty"));
        class1_list.add(new ReportCard("Clair"));
        class1_list.add(new ReportCard("Daniel"));
        class1_list.add(new ReportCard("Emma"));
        // set English marks
